<script>
	...
	import  Accordion  from '../components/Accordian/Accordian.svelte'
	import  AccordionItem  from '../components/Accordian/AccordianItem.svelte'
</script>
<div class="row">
	<PageHead heading="Education" subheading="Education" />
</div>
<div class="row">
	<div class="col-md-12" data-animate-effect="fadeInLeft">
		<Accordion>
			<AccordionItem title="Bachalors Of Computer Application" tabId="bca" active={true}>
				<div class="row">
					<div class="col-md-6">
			...
			<AccordionItem title="Higher Secondary" tabId="hs">
				<div class="row">
					<div class="col-md-6">
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
					</div>
			...
			<AccordionItem title="High School" tabId="school">
				<div class="row">
					<div class="col-md-6">
						<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. </p>
					</div>
